...
<div id="main">
		...
		<div id="content">
			<div style="height:50px"></div>
                ...
                <div class="titulo">
                    <h3 style="text-align:center">MANTENER PROFESION</h3>
                </div>
        	<div class="row-2">
        		<form action="insertar.php" id="formu" method="post">
        			...
        			<div class="ui-widget-content contenido" style="width:49%;">
         				PROFESION:
						<input type="text" name="nombre" id="nombre" style="width:60%;text-transform: uppercase" required placeholder="Escriba aqui la Profesion" />
				    </div>
