...
<div id="main">
		...
		<div id="content">
			<div style="height:50px"></div>
                ...
                <div class="titulo">
                    <h3 style="text-align:center">MANTENER SACERDOTE</h3>
                </div>
        	<div class="row-2">
        		<form action="insertar.php" id="formu" method="post">
				    ...
				    <div class="ui-widget-content contenido" style="width:22%;">
						Apellido:
						<input type="text" name="apellido" id="apellido" required placeholder="Escriba aqui su apellido" style="width:70%"/>
					</div>
					...
					<div class="ui-widget-content contenido" style="width:98%;">
						Correo:
						<input type="text" name="cedula" id="cedula" required placeholder="Escriba aqui su cedula" style="width:30%;text-transform: uppercase" />
					</div>
