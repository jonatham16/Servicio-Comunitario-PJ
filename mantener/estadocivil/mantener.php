...
<head>
	<meta charset="UTF-8">
	<title>Mantener Estado Civil</title>
...
<div id="main">
		...
		<div id="content">
			<div style="height:50px"></div>
                ...
                <div class="titulo">
                    <h3 style="text-align:center">MANTENER ESTADO CIVIL</h3>
                </div>
        	<div class="row-2">
...
$estadosCiviles=listadoEstadoCivil();
$nfilas=count($estadosCiviles);
if($nfilas==0){
...
?>		
                        <tr>
                            <td><button class="botonModificar" style="width:25px; height:25px;" value="<? echo $estadosCiviles[$i][0]; ?>">&nbsp;</button></td>
                            <td><button class="botonEliminar" style="width:25px; height:25px;" value="<? echo $estadosCiviles[$i][0]; ?>">&nbsp;</button></td>
                           
                           
                            <td><input id="nombre<?  echo $estadosCiviles[$i][0]; ?>" name"" type="text" value="<? echo $estadosCiviles[$i][1]; ?>" required /></td>
