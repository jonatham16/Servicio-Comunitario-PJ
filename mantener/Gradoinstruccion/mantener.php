...
<head>
	<meta charset="UTF-8">
	<title>Mantener Grado de Instruccion</title>
...
<div id="main">
		...
		<div id="content">
			<div style="height:50px"></div>
                ...
                <div class="titulo">
                    <h3 style="text-align:center">MANTENER GRADO DE INSTRUCCION</h3>
                </div>
        	<div class="row-2">
        		<form action="insertar.php" id="formu" method="post">

        			<div class="ui-widget-content contenido" style="width:55%" >
         				Grado de Instruccion:	<input type="text" name="nombre" id="nombre" style="width:60%;text-transform: uppercase" required placeholder="Escriba aqui el grado de Instruccion"/>
				    </div>
				...
				?>
                  <table>
					...
					?>		
                        <tr>
                            <td><button class="botonModificar" style="width:25px; height:25px;" value="<? echo $grado[$i][0]; ?>">&nbsp;</button></td>
                            <td><button class="botonEliminar" style="width:25px; height:25px;" value="<? echo $grado[$i][0]; ?>">&nbsp;</button></td>
                           
                           
                            <td><input id="nombre<?  echo $grado[$i][0]; ?>" name"" type="text" value="<? echo $grado[$i][1]; ?>" required /></td>
