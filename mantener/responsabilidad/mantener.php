...
<head>
	<meta charset="UTF-8">
	<title>Mantener Responsabilidad</title>
...
<div id="main">
		...
		<div id="content">
			<div style="height:50px"></div>
                ...
                <div class="titulo">
                    <h3 style="text-align:center">MANTENER RESPONSABILIDAD</h3>
                </div>
        	<div class="row-2">
        		<form action="insertar.php" id="formu" method="post">
				    ...
				    <div class="ui-widget-content contenido" style="width:48%;">
						Descripcion:
						<input name="descripcion" id="descripcion" required placeholder="Escriba aqui la descripcion" style="width:80%"/>
					</div>
