 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../../css/images/firstBlue.gif",  
			prevArrow : (new Image()).src="../../css/images/prevBlue.gif",
			lastArrow : (new Image()).src="../../css/images/lastBlue.gif",
			nextArrow : (new Image()).src="../../css/images/nextBlue.gif",
			rowsPerPage : 5,
			currPage : 1,
