...
//estos resquest hay q cambairlos xq si no si nos envian por get un parametro trae problemas de seguridad	
	...
	$insertar = "INSERT INTO 
				responsabilidad(resp_id, nombre, descripcion, activo) 
...
//Investigar el manejo de errores exepciones
	$consulta->execute() or die("Error insertando responsabilidad");
	echo json_encode("Responsabilidad registrada con Exito");
?>
