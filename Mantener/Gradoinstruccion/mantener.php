...
<head>
	<meta charset="UTF-8">
	<title>Mantener Grado Instruccion</title>
...
<body>
	...
	<input type="text" name="nombre" id="nombre" required placeholder="Indique el nuevo Grado de Instruccion"/>
<br>
...
$Ginstrucciones=listadoGInstruccion();
$nfilas=count($Ginstrucciones);
if($nfilas==0){
...
?>
                  <table>
                    ...
                    <th >Grados de Instruccion</th>
<?php
	for($i=0;$i<$nfilas;$i++){
?>		
                        <tr>
                            <td><button class="botonModificar" style="width:25px; height:25px;" value="<? echo $Ginstrucciones[$i][0]; ?>">&nbsp;</button></td>
                            <td><button class="botonEliminar" style="width:25px; height:25px;" value="<? echo $Ginstrucciones[$i][0]; ?>">&nbsp;</button></td>
                           
                           
                            <td><input id="nombre<?  echo $Ginstrucciones[$i][0]; ?>" name"" type="text" value="<? echo $Ginstrucciones[$i][1]; ?>" required /></td>
