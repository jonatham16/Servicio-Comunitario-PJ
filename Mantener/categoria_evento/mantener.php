...
<br>
	<input type="text" name="descripcion" id="nombre" placeholder="Escriba aqui la descripcion"/>
<br>
...
$categorias=listadoCategoria_evento();
$nfilas=count($categorias);
if($nfilas==0){
...
?>		
                        <tr>
                            <td><button class="botonModificar" style="width:25px; height:25px;" value="<? echo $categorias[$i][0]; ?>">&nbsp;</button></td>
                            <td><button class="botonEliminar" style="width:25px; height:25px;" value="<? echo $categorias[$i][0]; ?>">&nbsp;</button></td>
                           
                           
                            <td><input id="nombre<?  echo $categorias[$i][0]; ?>" name"" type="text" value="<? echo $categorias[$i][1]; ?>" required /></td>
			    <td><input id="descripcion<?  echo $categorias[$i][0]; ?>" name"" type="text" value="<? echo $categorias[$i][2]; ?>" /></td>
